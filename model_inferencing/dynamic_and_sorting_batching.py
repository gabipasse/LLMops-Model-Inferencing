...
def batch_generate(
    ...
    with torch.no_grad():
        # As tokenizer doesnt return in pytorch tensor format, it is necessary to check for the shape of the stacked tensor
...
def predict_sorted_batches(
    ...
    # Tensor format is removed because tensors require inputs of the same length (I remove it because I removed padding).
